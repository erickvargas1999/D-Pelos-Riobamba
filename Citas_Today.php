...
<head>
    ...
    <link rel="stylesheet" href="css/citashoy.css">
...
<body>
    ...
    <main>
        <section >
            <br><br>
            <h2 class="titulo">Citas del día</h2>
            <div class="contenedor-sobre-nosotros">
                ...
                <table id="miTabla" border="0" >
                    ...
                    $fechaActualEcuador = date("Y-m-d");
                    require("connection_db.php");
                    $query = "CALL sp_mostrar_citas_today('$fechaActualEcuador');";
                    ...
                    <?php
                        ...
                        ?>
                        <tr>
                            <td colspan="7" style="text-align: center;">Sin registros disponibles</td>
                        </tr>
