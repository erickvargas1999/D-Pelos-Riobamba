        ...
        <section >
            ...
            <div class="contenedor-sobre-nosotros">
                ...
                <table id="miTabla" border="0" >
                    ...
                    $query = "CALL sp_obtener_personas();";
                    ...
                    <tr>
                        ...
                        <td><?php echo $mostrar['birth'] ?></td>
                        <td><a href="" class="table__item__link">Cancelar</a></td>
                    </tr>
                    <?php 
                    }
                    ?>
                    ...
                    <script>
                            ...
                            for (var i = 0; i < filas.length; i++) {
                                filas[i].addEventListener("click", function () {
                                    ...
                                    enlaceCancelar.href = "eliminar_cita.php?CI=" +valorCelda;
                                });
                            }
                        </script>
                </table>
